...
public class MemberService {
    ...
    public TokenResponse refresh(String refreshToken) {
        ...
        if (!AuthOwnerTypes.MEMBER.equals(ownerType) || !"refresh".equals(tokenType)) {
            throw new MemberAccountException("refreshToken", ResponseMessages.TOKEN_INVALID);
        }
        ...
        if (authToken.getRefreshExpiresAt().isBefore(LocalDateTime.now())) {
            ...
            throw new MemberAccountException("refreshToken", ResponseMessages.TOKEN_EXPIRED);
        }
